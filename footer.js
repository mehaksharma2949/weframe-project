    ...
    >
      <div className="w-[149px] flex flex-col items-start justify-start pt-[49px] px-0 pb-0 box-border">
        <div className="flex flex-col items-start justify-start gap-3">
          ...
          <div className="relative tracking-[0.01em] font-light inline-block min-w-[71px]">
            Impressum
          </div>
      ...
      <div className="w-[369px] flex flex-row items-start justify-between py-0 pl-0 pr-[35px] box-border max-w-full gap-5 mq900:flex-wrap">
        <div className="flex flex-col items-start justify-start gap-3">
          <div className="relative tracking-[0.01em] font-light inline-block min-w-[58px]">
            Standort
          </div>
        ...
        <div className="flex flex-col items-start justify-start gap-3">
          <div className="relative tracking-[0.01em] font-light inline-block min-w-[48px]">
            Telefon
          </div>
          <div className="relative text-base font-extrabold font-manrope text-white inline-block min-w-[114px] whitespace-nowrap">
            0223 545 5250
          </div>
        </div>
      </div>
      ...
      />
      <div className="flex flex-col items-start justify-start gap-3">
        <div className="relative tracking-[0.01em] font-light inline-block min-w-[98px]">
          Öffnungszeiten
        </div>
        <div className="flex flex-col items-start justify-start gap-1">
          <div className="relative tracking-[0.01em] leading-[15.11px] font-light inline-block min-w-[39px]">
            Mo-Fr
          </div>
        ...
        <div className="flex flex-col items-start justify-start gap-1">
          <div className="relative tracking-[0.01em] font-light inline-block min-w-[17px]">
            Sa
          </div>
          <div className="relative text-base font-extrabold font-manrope text-white whitespace-nowrap">
            09:00 – 14:00 Uhr
