...
const IconCart = ({ className = "" }) => {
  return (
    ...
    >
      <div className="absolute top-[7px] left-[18px] rounded-3xl bg-secondary-30 w-[18px] overflow-hidden flex flex-row items-start justify-start pt-0.5 px-[5px] pb-[1.7px] box-border">
        <div className="relative font-medium inline-block min-w-[7px]">1</div>
      </div>
      <img
