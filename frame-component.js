      ...
      >
        <div className="self-stretch flex flex-col items-start justify-start gap-6">
          <div className="self-stretch flex flex-col items-start justify-start gap-5">
            ...
            <div className="self-stretch h-[54px] relative text-lg tracking-[0.09px] font-semibold text-black inline-block shrink-0">
              {navcoraTHCSpotlightPortoMast}
            </div>
          </div>
        ...
        <div className="self-stretch flex flex-row items-center justify-between gap-[7px] text-5xl text-primary">
          <div className="flex flex-col items-start justify-start gap-0.5">
            <div className="flex flex-row items-start justify-start gap-1">
              ...
              <div className="flex flex-row items-center justify-start gap-px text-black">
                <div className="relative tracking-[0.01em] font-extrabold inline-block min-w-[63px] mq450:text-lgi">
                  11,66
                </div>
            ...
            <div className="relative text-xs tracking-[0.01em] leading-[15.11px] font-light text-secondary-text inline-block min-w-[73px]">
              pro Gramm
            </div>
          </div>
          <ButtonPrimary />
